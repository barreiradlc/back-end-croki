...
function getClient(scopes) {
    ...
    credentials = {
        client_id: 'zHSMtm0XYiMmJVaQpJW5UboGXOvtq1LE',
        client_secret: '9ZTSMVMn2wOOz1eC',
        callback_url: 'localhost:3000'
    }
    return new AuthClientTwoLegged(config.credentials.client_id, config.credentials.client_secret, scopes || config.scopes.internal);
}
